...
import heroIllustration from './assets/hero-illustration-soft.png'
import automationIcon from './assets/automation-icon-soft.png'
import contentCreation from './assets/content-creation-soft.png'
import resultsGraphic from './assets/results-graphic-soft.png'
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-100 via-blue-100 to-slate-200 py-20 px-4">
        <div className="absolute inset-0 bg-white/30"></div>
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-40"></div>
        
        {/* Floating elements */}
        <div className="absolute top-20 left-10 w-20 h-20 bg-blue-200/30 rounded-full blur-xl animate-pulse"></div>
        <div className="absolute top-40 right-20 w-32 h-32 bg-slate-200/40 rounded-full blur-2xl animate-pulse delay-1000"></div>
        <div className="absolute bottom-20 left-1/4 w-16 h-16 bg-blue-100/40 rounded-full blur-xl animate-pulse delay-500"></div>
        
        <div className="relative max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center bg-blue-100/80 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
                <Sparkles className="w-5 h-5 text-blue-600 mr-2" />
                <span className="text-slate-700 font-medium">Автоматизация контента</span>
              </div>
              ...
              <Button 
                size="lg" 
                className="bg-slate-600 text-white hover:bg-slate-700 px-8 py-4 text-lg rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl font-semibold"
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-blue-200/20 to-slate-200/20 rounded-3xl blur-3xl transform rotate-6"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-white relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-slate-300 via-blue-300 to-slate-300"></div>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center bg-red-50 text-red-500 rounded-full px-4 py-2 mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              { text: "Блог не привлекает клиентов — не знаешь, что и когда публиковать?", icon: "😤", color: "border-red-100 bg-red-25" },
              { text: "Нет времени и сил вести соцсети самому?", icon: "😴", color: "border-orange-100 bg-orange-25" },
              { text: "Устал платить подрядчикам или объяснять своё видение чужой команде?", icon: "💸", color: "border-yellow-100 bg-yellow-25" },
              { text: "Хотел бы переключить свой блог на автопилот и заняться стратегией?", icon: "🤔", color: "border-blue-100 bg-blue-25" }
            ].map((pain, index) => (
              <Card key={index} className={`${pain.color} border shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group`}>
          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-slate-600 to-blue-600 text-white rounded-2xl p-8 max-w-4xl mx-auto shadow-lg">
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-slate-50 to-blue-50 relative">
        <div className="absolute top-10 right-10 w-32 h-32 bg-blue-100/40 rounded-full blur-2xl"></div>
        <div className="absolute bottom-10 left-10 w-24 h-24 bg-slate-100/40 rounded-full blur-xl"></div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: Users, title: "Эксперты и предприниматели", gradient: "from-blue-300 to-blue-400" },
              { icon: Target, title: "Блогеры", gradient: "from-slate-300 to-slate-400" },
              { icon: MessageSquare, title: "Консультанты/коучи", gradient: "from-blue-200 to-blue-300" },
              { icon: Award, title: "Все, кто хочет результат", gradient: "from-slate-200 to-slate-300" }
            ].map((item, index) => (
      ...
      <section className="py-20 px-4 bg-white relative">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center bg-green-50 text-green-600 rounded-full px-4 py-2 mb-6">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={index} className="flex items-start space-x-4 group">
                    <div className="w-8 h-8 bg-gradient-to-r from-green-400 to-green-500 rounded-full flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="relative">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-r from-green-100/30 to-blue-100/30 rounded-3xl blur-3xl transform -rotate-6"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Course Program */}
      <section className="py-20 px-4 bg-gradient-to-br from-slate-700 via-slate-800 to-slate-900 text-white relative overflow-hidden">
            ...
            {modules.map((module) => (
              <Collapsible key={module.id} open={openModules[module.id]} onOpenChange={() => toggleModule(module.id)}>
                <CollapsibleTrigger asChild>
                  <Card className="cursor-pointer bg-white/5 backdrop-blur-sm border-white/10 hover:bg-white/10 transition-all duration-300 hover:scale-[1.01] group">
                    <CardHeader className="flex flex-row items-center justify-between p-6">
                      <div className="flex items-center space-x-4">
                        <div className={`w-12 h-12 bg-gradient-to-r ${module.color} rounded-xl flex items-center justify-center font-bold text-white text-lg shadow-md group-hover:scale-110 transition-transform duration-300`}>
                          {module.id}
                        </div>
                        <h3 className="text-lg font-semibold text-white text-left group-hover:text-blue-200 transition-colors duration-300">{module.title}</h3>
                      </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center bg-slate-50 text-slate-600 rounded-full px-4 py-2 mb-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { text: "Чат поддержки и разборы работ", icon: MessageSquare, color: "from-blue-300 to-blue-400" },
              { text: "Домашние задания: учишься на своих темах и проектах", icon: Target, color: "from-slate-300 to-slate-400" },
              { text: "Вечный доступ ко всем материалам", icon: Clock, color: "from-blue-200 to-blue-300" },
              { text: "Проходишь в своём темпе или по расписанию", icon: Zap, color: "from-slate-200 to-slate-300" }
            ].map((item, index) => (
      ...
      {/* Results */}
      <section className="py-20 px-4 bg-gradient-to-br from-green-25 to-blue-25 relative">
        <div className="absolute top-10 left-10 w-32 h-32 bg-green-100/40 rounded-full blur-2xl"></div>
        <div className="absolute bottom-10 right-10 w-24 h-24 bg-blue-100/40 rounded-full blur-xl"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <img 
                ...
                className="w-full max-w-md mx-auto drop-shadow-xl"
              />
              <div className="absolute inset-0 bg-gradient-to-r from-green-100/20 to-blue-100/20 rounded-3xl blur-3xl transform rotate-6"></div>
            </div>
            <div>
              <div className="inline-flex items-center bg-green-50 text-green-600 rounded-full px-4 py-2 mb-6">
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-green-500 to-blue-500 text-white rounded-2xl shadow-lg">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center bg-yellow-50 text-yellow-600 rounded-full px-4 py-2 mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group overflow-hidden">
                <div className="h-1 bg-gradient-to-r from-yellow-300 to-yellow-400"></div>
                <CardContent className="p-8">
                  ...
                  <div className="flex items-center">
                    <div className="w-12 h-12 bg-gradient-to-r from-blue-400 to-slate-400 rounded-full flex items-center justify-center text-white font-bold text-lg mr-4">
                      {testimonial.avatar}
                    </div>
      ...
      {/* Pricing */}
      <section id="pricing" className="py-20 px-4 bg-gradient-to-br from-slate-700 via-slate-800 to-slate-900 text-white relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-50"></div>
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              <Card key={index} className={`bg-white/5 backdrop-blur-sm border-white/10 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group overflow-hidden ${plan.popular ? 'ring-1 ring-blue-300 relative scale-105' : ''}`}>
                {plan.popular && (
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                    <span className="bg-gradient-to-r from-blue-400 to-blue-500 text-white px-4 py-1 rounded-full text-sm font-bold shadow-md">
                      ⭐ Популярный
                    </span>
                  </div>
                )}
                ...
                <CardHeader className="text-center p-8">
                  ...
                  <div className="mb-4">
                    <span className="text-4xl font-bold bg-gradient-to-r from-blue-300 to-slate-300 bg-clip-text text-transparent">{plan.discountPrice}</span>
                ...
                <CardContent className="p-8 pt-0">
                  ...
                  <Button 
                    className={`w-full bg-gradient-to-r ${plan.gradient} hover:scale-105 text-white transition-all duration-300 py-3 font-semibold shadow-md`}
      ...
      {/* Contacts */}
      <section id="contacts" className="py-20 px-4 bg-gradient-to-br from-blue-50 to-slate-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-blue-400 to-blue-500 hover:from-blue-500 hover:to-blue-600 text-white py-6 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl font-semibold"
            ...
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-slate-500 to-slate-600 hover:from-slate-600 hover:to-slate-700 text-white py-6 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl font-semibold"
            ...
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-green-400 to-green-500 hover:from-green-500 hover:to-green-600 text-white py-6 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl font-semibold"
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-slate-700 via-slate-800 to-slate-900 text-white relative overflow-hidden">
        ...
        <div className="absolute bottom-10 right-10 w-32 h-32 bg-slate-200/20 rounded-full blur-2xl animate-pulse delay-1000"></div>
        
        <div className="max-w-4xl mx-auto text-center relative">
          <div className="inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-8">
            <Rocket className="w-5 h-5 text-blue-300 mr-2" />
            <span className="text-white font-medium">Финальный призыв</span>
          </div>
          <h2 className="text-3xl md:text-5xl font-bold mb-8 bg-gradient-to-r from-blue-200 to-slate-200 bg-clip-text text-transparent">
          ...
          <Button 
            size="lg" 
            className="bg-gradient-to-r from-blue-500 to-slate-500 hover:from-blue-600 hover:to-slate-600 text-white px-12 py-6 text-xl rounded-2xl transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-xl font-bold"
            onClick={() => window.open('https://t.me/tolgsky', '_blank')}
          >
